...
%% various
saveMovie = 1;    % logical (set to 1 if you want to save a movie)
...
videoCodecSetting = ':CodecType=theoraenc EncodingQuality=1';
...
%% other settings
nCycles = 1; % number of motion cycles for the video
ScreenRes = [1024, 768];
...
if saveMovie
    ...
    moviePtr = Screen('CreateMovie', scr.main, movieName, movieX, movieY, 60, videoCodecSetting);
end
...
if saveMovie
    ...
    movieX = imageRect(3)-imageRect(1);     movieY = imageRect(4)-imageRect(2);
    moviePtr2 = Screen('CreateMovie', scr.main, movieName, movieX, movieY, 60, videoCodecSetting);
